...
class Test_Adapter_Activity() :
    ...
    @pytest.mark.parametrize("code", [("1999999999999999"), ("esempio"), ("cacaca")])
    ...
    @pytest.mark.parametrize("date", [("2022-02-30"), ("2022-02-0111"), ("1999-13-25")])
    ...
    def test_Adapter_Activity_Billable_Hours_Incorrect(self,billable_hours,server):        
        client = Client(server)
        login(client)
        client.getResponse("consuntiva")
        client.getResponse("1")
    ...
    def test_Adapter_Activity_Travel_Hours_Incorrect(self,travel_hours,server):        
        client = Client(server)
        login(client)
        client.getResponse("consuntiva")
        client.getResponse("1")
    ...
    @pytest.mark.parametrize("billable_travel_hours", [("no"), ("-5.4"), ("cinque")])
    def test_Adapter_Activity_Billable_Travel_Hours_Incorrect(self,billable_travel_hours,server):
    ...
    @pytest.mark.parametrize("Bologna", [("boligna"), ("Bologna"), ("bolonia")])
