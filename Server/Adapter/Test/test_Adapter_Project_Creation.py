...
class Test_Adapter_Project_Creation():
    ...
    def test_Adapter_Creation_Code_Correct(self,chatbot):
        S = Statement_State("1999",State_Project_Creation(),'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Codice progetto libero : Inserire una descrizione" and S.currentState.getData()['codice progetto'] =="1999"

    # Test Inserimento Codice Progetto Incorretto
    def test_Adapter_Creation_Code_Incorrect(self,chatbot):
        S = Statement_State("1",State_Project_Creation(),'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Codice progetto in uso : Reinserire un codice diverso" and S.currentState.getData()['codice progetto'] ==""
    ...
    def test_Adapter_Creation_Details_Correct(self,chatbot):
        ...
        S = Statement_State("template details",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Descrizione Accettata : Inserire Cliente" and S.currentState.getData()['dettagli'] =="template details"
    ...
    def test_Adapter_Creation_Client_Correct(self,chatbot):
        ...
        S = Statement_State("cliente",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Cliente Accettato : Inserire Manager" and S.currentState.getData()['cliente'] =="cliente"
    ...
    def test_Adapter_Creation_Manager_Correct(self,chatbot):
        ...
        S = Statement_State("manager",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Manager Accettato : Inserire Area" and S.currentState.getData()['manager'] =="manager"
    ...
    def test_Adapter_Creation_Area_Correct(self,area,chatbot):
        ...
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Area Accettata : Inserire Data Inizio" and S.currentState.getData()['area'] in area
    ...
    def test_Adapter_Creation_Area_Incorrect(self,chatbot):
        ...
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Area non Accettata : Reinserire il nome dell'area" and S.currentState.getData()['area'] == ""
    ...
    def test_Adapter_Creation_Start_Date_Correct(self,chatbot):
        ...
        S = Statement_State("2022-01-01",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Data di Inizio accettata : Inserire la Data di Fine" and S.currentState.getData()['data Inizio'] == "2022-01-01"
    ...
    def test_Adapter_Creation_Start_Date_Incorrect(self,chatbot):
        ...
        Spc.addData("manager","manager")
        Spc.addData("area","bologna")
        S = Statement_State("2022-01-011",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Data di Inizio non accettata : Reinserire la data del progetto" and S.currentState.getData()['data Inizio'] == ""
    ...
    def test_Adapter_Creation_End_Date_Correct(self,chatbot):
        ...
        S = Statement_State("2022-01-02",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Data di Fine accettata : Confermare la creazione?" and S.currentState.getData()['data Fine'] == "2022-01-02"
    ...
    def test_Adapter_Creation_End_Date_Incorrect(self,chatbot):
        ...
        Spc.addData("area","bologna")
        Spc.addData("data Inizio","2022-01-01")
        S = Statement_State("2022-01-022",Spc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
        assert value.text == "Data di Fine non accettata : Reinserire la data del progetto" and S.currentState.getData()['data Fine'] == ""
    ...
    def test_Adapter_Creation_Modify_Code(self, chatbot):
        ...
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Codice progetto libero e dato aggiornato." in value.text and S.currentState.getData()['codice progetto'] == "5"
    ...
    def test_Adapter_Creation_Modify_Details(self, chatbot):
        ...
        S = Statement_State('descrizopme',Sc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Descrizione Accettata e aggiornata." in value.text and S.currentState.getData()['dettagli'] == "descrizopme"
    ...
    def test_Adapter_Creation_Modify_Client(self, chatbot):
        ...
        S = Statement_State('clientino',Sc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Cliente Accettato e aggiornato." in value.text and S.currentState.getData()['cliente'] == "clientino"
    ...
    def test_Adapter_Creation_Modify_Manager(self, chatbot):
        ...
        S = Statement_State('managerino',Sc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Manager Accettato e aggiornato." in value.text and S.currentState.getData()['manager'] == "managerino"
    ...
    def test_Adapter_Creation_Modify_Area(self, chatbot):
        ...
        S = Statement_State('Imola',Sc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Area Accettata e aggiornata." in value.text and S.currentState.getData()['area'] == "imola"
    ...
    def test_Adapter_Creation_Modify_Start_Date(self, chatbot):
        ...
        S = Statement_State('2022-05-05',Sc,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Data di Inizio accettata e aggiornata." in value.text and S.currentState.getData()['data Inizio'] == "2022-05-05"
    ...
    def test_Adapter_Creation_Modify_End_Date(self, chatbot):
        ...
        A = Adapter_Project_Creation(chatbot)
        value = A.process(S,None)
        assert "Data di Fine accettata e aggiornata." in value.text and S.currentState.getData()['data Fine'] == "2022-05-05"
