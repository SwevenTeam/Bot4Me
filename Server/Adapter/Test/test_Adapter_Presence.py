...
class Test_Adapter():
    ...
    def test_Adapter_Presence_Activate(self, chatbot):
        S = Statement_State("presenza",State_Null(),'12345678-1234-1234-1234-123456789012')
    ...
    def test_Adapter_Presence_Location_Correct(self, sede, chatbot):
        S = Statement_State(sede,State_Presence(),'12345678-1234-1234-1234-123456789012')
        A = Adapter_Presence(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
    ...
    def test_Adapter_Presence_Location_Incorrect(self, chatbot):
        S = Statement_State("Padova",State_Presence(),'12345678-1234-1234-1234-123456789012')
        A = Adapter_Presence(chatbot)
        if A.can_process(S):
            value = A.process(S,None)
