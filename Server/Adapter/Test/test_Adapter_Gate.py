...
class Test_Adapter_Gate():
    ...
    def test_Adapter_Gate_Area(self, chatbot):
        S = Statement_State("imola", State_Gate(),'12345678-1234-1234-1234-123456789012')
        A = Adapter_Gate(chatbot)
        if A.can_process(S):
            value = A.process(S, None)
    ...
    def test_Adapter_Gate_Modify(self, chatbot):
        ...
        S = Statement_State("modifica", Sg,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Gate(chatbot)
        if A.can_process(S):
            value = A.process(S, None)
    ...
    def test_Adapter_Gate_Confirm_Again(self, chatbot):
        Sg = State_Gate()
        Sg.addData("sede","imola")
        S = Statement_State("asdasdasdsadsad", Sg,'12345678-1234-1234-1234-123456789012')
        A = Adapter_Gate(chatbot)
        if A.can_process(S):
            value = A.process(S, None)
