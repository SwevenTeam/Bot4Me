...
class Adapter_Project_Creation(LogicAdapter):
    ...
    def process(self, input_statement, additional_response_selection_parameters) -> Statement_State:
        ...
        if s.getCurrentState() and s.getCurrentState() == "Iniziale":
            ...
            return Statement_State("Creazione Progetto Avviata : Inserire il codice del Progetto",s)
        ...
        if ( not dati["codice progetto"]  ) or dati["conferma"]=="codice progetto":
            ...
            if checkCodeProject(testo,Api) :
                ...
                if dati["conferma"]=="codice progetto":
                    ...
                    output_statement=Statement_State("Codice progetto libero e dato aggiornato. Visualizzazione Dati Aggiornati \n " + returnAllData(s) +"Confermare operazione di creazione?",s)
                # Se è un'operazione di primo inserimento
                else:
                    output_statement=Statement_State("Codice progetto libero : Inserire una descrizione",s)
            else :
                output_statement=Statement_State("Codice progetto in uso : Reinserire un codice diverso",s)   
        ...
        # Utente ha inserito la sede, ora dovrà inserire la descrizione
            ...
            if dati["conferma"]=="dettagli" :
                s.addData("conferma","non confermato")
                output_statement=Statement_State("Descrizione Accettata e aggiornata. Visualizzazione Dati Aggiornati \n" + returnAllData(s) +" Confermare operazione di creazione?",s)
            # Se è un'operazione di primo inserimento
            else:
        ...
        # Utente ha inserito i dettagli, ora dovrà inserire il cliente
            ...
            if dati["conferma"]=="cliente" :
                s.addData("conferma","non confermato")
                output_statement=Statement_State("Cliente Accettato e aggiornata. Visualizzazione Dati Aggiornati \n" + returnAllData(s) +" Confermare operazione di creazione?",s)
            # Se è un'operazione di primo inserimento
            else:
        ...
        # Utente ha inserito il cliente, ora dovrà inserire i dettagli
            ...
            if dati["conferma"]=="manager" :
                s.addData("conferma","non confermato")
                output_statement=Statement_State("Manager Accettata e aggiornata. Visualizzazione Dati Aggiornati \n" + returnAllData(s) +" Confermare operazione di creazione?",s)
            # Se è un'operazione di primo inserimento
            else:
        ...
        # Controllo quindi se nel messaggio inviato dall'utente sia presente una delle due Sedi
            ...
            if any(x in testo.split() for x in sedeP):
                ...
                if dati["conferma"]=="area" :
                    s.addData("conferma","non confermato")
                    output_statement=Statement_State("Area Accettata e aggiornata. Visualizzazione Dati Aggiornati \n " + returnAllData(s) +" Confermare operazione di creazione?",s)
                # Se è un'operazione di primo inserimento
                else:
                    output_statement=Statement_State("Area Accettata : Inserire Data Inizio",s)
                ...
                output_statement=Statement_State("Area non Accettata : Reinserire il nome dell'area",s)
        ...
        # Utente ha inserito il codice e questo esiste, ora dovrà inserire la data
            ...
            try:
                ...
                if dati["conferma"]=="data":
                    s.addData("conferma","non confermato")
                    output_statement=Statement_State("Data di Inizio accettata e aggiornata. Visualizzazione Dati Aggiornati \n" + returnAllData(s) +"Confermare operazione di creazione?",s)
                # Se è un'operazione di primo inserimento
                else:
                    output_statement=Statement_State("Data di Inizio accettata : Inserire la Data di Fine",s)
            except ValueError:
                output_statement=Statement_State("Data di Inizio non accettata : Reinserire la data del progetto",s)
        # Utente ha inserito il codice e questo esiste, ora dovrà inserire la data
            ...
            try:
                ...
                if dati["conferma"]=="data":
                    s.addData("conferma","non confermato")
                    output_statement=Statement_State("Data di Fine accettata e aggiornata. Visualizzazione Dati Aggiornati \n" + returnAllData(s) +"Confermare operazione di creazione?",s)
                # Se è un'operazione di primo inserimento
                else:
                    output_statement=Statement_State("Data di Fine accettata : Confermare la creazione?",s)
            except ValueError:
                output_statement=Statement_State("Data di Fine non accettata : Reinserire la data del progetto",s)
